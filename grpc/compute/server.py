...
class ComputeServicer(compute_pb2_grpc.ComputeServicer):
    ...
    def SayHello2(self, request, ctx):
        return compute_pb2.HelloReply(result="hello " + request.helloworld + "!")

    def GetLen(self, request, ctx):
        return compute_pb2.HelloReplyInt(result=len("hello " + request.helloworld + "!"))
